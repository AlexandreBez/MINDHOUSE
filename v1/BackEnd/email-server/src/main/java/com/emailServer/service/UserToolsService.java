...
public class UserToolsService {
	...
	public ResponseEntity<CustomResponse> sendTempPassword(String email, String password){
		...
		try {
			...
			String htmlBody = templateEngine.process("UserTools/TempPassword", context);

			// Get filename in the Path String
			emailFactory.emailNoReplyGenerator(email,"Mindhouse account created",htmlBody,null, null);
